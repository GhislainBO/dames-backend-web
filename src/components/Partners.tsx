...
const PARTNERS: Partner[] = [
  ...
  },
  {
    id: 'slot1',
    name: 'Votre Logo Ici',
    description: 'Emplacement disponible pour sponsor Or',
    tier: 'gold',
  },
  {
    id: 'club1',
    name: 'Club de Dames de Paris',
    description: 'Club partenaire pour les evenements et tournois.',
    tier: 'silver',
    url: '#',
  },
  {
    id: 'slot2',
    name: 'Votre Logo Ici',
    description: 'Emplacement disponible pour sponsor Argent',
    tier: 'silver',
  },
  {
    id: 'slot3',
    name: 'Votre Logo Ici',
    description: 'Emplacement disponible pour sponsor Bronze',
    tier: 'bronze',
  },
];
      ...
      <div className="partners-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="partners-grid">
          {PARTNERS.map(partner => (
            <div
              key={partner.id}
              className={`partner-card tier-${partner.tier} ${partner.url ? 'clickable' : 'placeholder'}`}
              onClick={() => openPartnerLink(partner.url)}
              ...
              <div className="partner-logo">
                {partner.logo ? (
                  ...
                  <span className="logo-placeholder">
                    {partner.name.includes('Votre') ? '?' : partner.name.charAt(0)}
                  </span>
                )}
              </div>
              <h4>{partner.name}</h4>

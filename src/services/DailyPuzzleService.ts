...
const PUZZLES: Omit<DailyPuzzle, 'id' | 'date'>[] = [
  ...
  },
  {
    ...
    description: 'Gagnez avec votre dame contre deux pions.',
    difficulty: 'hard',
    playerColor: 'white',
    pieces: [
      { row: 9, col: 0, color: 'white', isKing: true },
      { row: 1, col: 2, color: 'black', isKing: false },
      { row: 2, col: 3, color: 'black', isKing: false },
    ],
    solution: ['46-5'],
    hint: 'Positionnez votre dame pour controler les deux pions.',
  },
  {
    ...
    playerColor: 'white',
    pieces: [
      { row: 3, col: 2, color: 'white', isKing: false },
      { row: 3, col: 4, color: 'white', isKing: false },
      { row: 4, col: 5, color: 'white', isKing: false },
      { row: 2, col: 3, color: 'black', isKing: false },
      { row: 1, col: 4, color: 'black', isKing: false },
    ],
    solution: ['12-7', '8x17x28'],
